...
import com.vartime.easy.spring.boot.validator.Validator;
...
public class ValidateInterceptor {
    ...
    @Pointcut("@annotation(com.vartime.easy.spring.boot.validator.annotation.Validate) && @annotation(validate)")
