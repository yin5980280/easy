package com.easy.site.spring.boot.configuration;


import com.easy.site.framework.utils.SpringApplicationUtils;
import com.easy.site.spring.boot.interceptor.ClientHttpRequestInterceptorImpl;
import com.easy.site.spring.boot.converter.GlobalMessageConverter;
import com.easy.site.spring.boot.converter.TextPlainMappingJackson2HttpMessageConverter;
import com.easy.site.spring.boot.interceptor.DefaultExceptionHandler;
import com.easy.site.spring.boot.interceptor.ResponseBodyWrapFactoryBean;
import com.easy.site.spring.boot.interceptor.ValidateInterceptor;
