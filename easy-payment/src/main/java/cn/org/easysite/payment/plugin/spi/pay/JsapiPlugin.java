 ...
 * @link : com.iot.trade.core.payment.gateway.plugin.spi.pay.JsapiPlugin
 */
public interface JsapiPlugin extends PreCreatePlugin<PayParameter, PayPreCreateResult> {
    /**
     * 微信针对公众号，支付宝针对生活号
     * @param payParameter
     * @return
     */
    @PayType("JSAPI")
    PayPreCreateResult jsapi(PayParameter payParameter);
}
