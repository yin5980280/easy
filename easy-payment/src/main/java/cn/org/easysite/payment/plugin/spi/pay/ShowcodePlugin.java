 ...
 * @link : com.iot.trade.core.payment.gateway.plugin.spi.pay.ShowcodePlugin
 */
public interface ShowcodePlugin extends PayPlugin<PayParameter, PayResult> {
    /**
     * 被扫支付
     * @param payParameter
     * @return
     */
    @PayType("SHOWCODE")
    PayPreCreateResult showcode(PayParameter payParameter);
}
